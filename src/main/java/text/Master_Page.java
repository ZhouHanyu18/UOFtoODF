...
public class Master_Page {
	...
	public static void commit_result(){
		...
		rst += " style:name=\"Standard\"";	//ÔÝÉèÎªStandard,ÓÐ´ý¸Ä½ø
	...
	public static void process_start(String qName,Attributes atts){		
		...
		else if(qName.equals("×Ö:ÆæÊýÒ³Ò³Ã¼")){
			_text_content_tag = true;
			_page_content += "<style:header>";
		}
		else if(qName.equals("×Ö:Å¼ÊýÒ³Ò³Ã¼")){
			_text_content_tag = true;
			_page_content += "<style:header-left>";
		}
		else if(qName.equals("×Ö:ÆæÊýÒ³Ò³½Å")){
			_text_content_tag = true;
			_page_content += "<style:footer>";
		}
		else if(qName.equals("×Ö:Å¼ÊýÒ³Ò³½Å")){
			_text_content_tag = true;
			_page_content += "<style:footer-left>";
		}
		else if(qName.equals("×Ö:Ê×Ò³Ò³Ã¼")||qName.equals("×Ö:Ê×Ò³Ò³½Å")){
			_filter_tag = true;
		}
	}
